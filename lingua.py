            ...
            if is_b1_teil3:
                ...
                if lvl == "A2":
                    ai_system_prompt = (
                        ...
                        "4. If the student confirms, use your suggested keywords. If yes or ja, start with the first question. If no or nein, let the student provide their own keywords, and then proceed with the conversation using those.\n"
