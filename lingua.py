            ...
            if is_b1_teil3:
                ...
                if lvl == "A2":
                    ai_system_prompt = (
                        ...
                        "1. Teach students how to build their points on chosen topic. "
                        "2. Always stay on the student's chosen topic with 4 keywords that relate to the topic for the session. "
